...
public class EntityAIMoveTowardsRestriction2 extends EntityAIBase {
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            Vec3d vec3d = this.creature.getMaximumHomeDistance() == 0 ? new Vec3d(blockpos) : RandomPositionGenerator.findRandomTargetBlockTowards(this.creature, (int) Math.min(this.creature.getMaximumHomeDistance(), 16), 7, new Vec3d((double)blockpos.getX(), (double)blockpos.getY(), (double)blockpos.getZ()));
