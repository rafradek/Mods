...
public class RenderSyringe extends Render<EntityStickProjectile> {
	...
	public RenderSyringe(RenderManager manager) {
		super(manager);
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityStickProjectile entity) {
