...
public class ModelBuild extends ModelBase {
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		GlStateManager.translate(this.shape1_11.rotationPointX * f5, this.shape1_11.rotationPointY * f5,
				this.shape1_11.rotationPointZ * f5);
		...
		GlStateManager.translate(this.shape1_10.rotationPointX * f5, this.shape1_10.rotationPointY * f5,
				this.shape1_10.rotationPointZ * f5);
		...
		GlStateManager.translate(this.shape1_8.rotationPointX * f5, this.shape1_8.rotationPointY * f5,
				this.shape1_8.rotationPointZ * f5);
		...
		GlStateManager.translate(this.shape1_9.rotationPointX * f5, this.shape1_9.rotationPointY * f5,
				this.shape1_9.rotationPointZ * f5);
		GlStateManager.scale(0.5D, 1.0D, 0.5D);
		GlStateManager.translate(-this.shape1_9.offsetX, -this.shape1_9.offsetY, -this.shape1_9.offsetZ);
		GlStateManager.translate(-this.shape1_9.rotationPointX * f5, -this.shape1_9.rotationPointY * f5,
				-this.shape1_9.rotationPointZ * f5);
