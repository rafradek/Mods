...
public class GuiTeleporter extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList
				.add(this.teleportUpBtn = new GuiButton(1, this.width / 2 - 55, this.height / 2 - 10, 20, 20, "+"));
		this.buttonList
				.add(this.teleportDownBtn = new GuiButton(2, this.width / 2 - 15, this.height / 2 - 10, 20, 20, "-"));
		this.buttonList
